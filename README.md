...
The documented declarations exported by the `tui` modules are the public API.
During `1.x`, public types, functions, ownership rules, and named errors stay
...
| `tui.render` | Incremental frames, clipped surfaces, styles, cursors, and cells |
| `tui.terminal` | POSIX sessions, capabilities, links, clipboard, bell, and notifications |
...
| `tui.editor` | Multiline text, cursors, selection, viewports, and optional soft wrapping |
| `tui.layout` | Insets, constraints, placement, flex splits, and grids |
| `tui.widget` | Labels, controls, editors, scrollback, lists, tables, and menus |
